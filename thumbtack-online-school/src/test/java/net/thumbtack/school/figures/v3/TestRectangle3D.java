...
public class TestRectangle3D {
    ...
    public void testIsPointInsideRectangle3D3() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        assertTrue(rect3D.isInside(new Point3D(20, 30,5)));
        assertTrue(rect3D.isInside(new Point3D(10, 30,3)));
        assertTrue(rect3D.isInside(new Point3D(30, 30,2)));
        assertTrue(rect3D.isInside(new Point3D(10, 40,1)));
        assertFalse(rect3D.isInside(new Point3D(0, 0,0)));
        assertFalse(rect3D.isInside(new Point3D(10, 100,11)));
    ...
    public void testIsPointInsideRectangle3D4() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        assertTrue(rect3D.isInside(20, 30,5));
        assertTrue(rect3D.isInside(10, 30,3));
        assertTrue(rect3D.isInside(30, 30,2));
        assertTrue(rect3D.isInside(10, 40,1));
        assertFalse(rect3D.isInside(0, 0,0));
        assertFalse(rect3D.isInside(10, 100,11));
        assertFalse(rect3D.isInside(-10, 20,12));
