...
public class TestFigure {
    ...
    public void testIsInside2() throws ColorException {
        Figure[] figures = new Figure[3];
        figures[0] = new Circle(0, 0, 10, Color.GREEN);
        figures[1] = new Rectangle(-10, -20, 10, 20, Color.GREEN);
        Point2D point1 = new Point2D(2, 0);
        Point2D point2 = new Point2D(-1, 0);
        Point2D point3 = new Point2D(0, 2);
        figures[2] = new Triangle(point1, point2, point3, Color.GREEN);
        for (Figure figure : figures)
    ...
    public void testIsInside3() throws ColorException {
        Figure[] figures = new Figure[3];
        figures[0] = new Circle(0, 0, 10, Color.RED);
        figures[1] = new Rectangle(-10, -20, 10, 20, Color.RED);
        Point2D point1 = new Point2D(2, 0);
        Point2D point2 = new Point2D(-1, 0);
        Point2D point3 = new Point2D(0, 2);
        figures[2] = new Triangle(point1, point2, point3, Color.RED);
        for (Figure figure : figures)
            assertTrue(figure.isInside(new Point2D(0, 0)));
    }
